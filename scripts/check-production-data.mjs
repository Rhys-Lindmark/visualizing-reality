...
const releaseId='20260901-steppe-migration1';
...
const assets=[
  ...
  ['csv','/data/steppe/20260901-bargains1/frontier-bargain-packages.csv'],
  ['csv','/data/steppe/20260901-migration1/steppe-migration-outcomes.csv'],
