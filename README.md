...
The cradles of civilization now has its first of five insights live. A selectable world map compares urban scale, political centralization, and durable notation across Mesopotamia, Egypt, the Indus, northern China, Mesoamerica, and the Andes. Eighteen source-keyed observations preserve phase ranges and evidence status; the Indus political form remains contested, San Andrés notation remains probable and contested, earlier Chinese signs remain distinct from secure Shang writing, and the Andes notation lane is an undated evidence gap rather than year zero.

Next is Page 03 insight 02: compare rivers, rainfall, crops, transport, and settlement density without turning six unlike landscapes into one hydraulic-state formula. Bronze Age and Iron Age pages follow.
