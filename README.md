...
The Iron Age transformation now has two of five insights live. Five regional comparisons separate earliest or limited evidence from wider adoption and make the production chain inspectable. Eleven published modern smelting runs then compare ore, charcoal, and reported bloom outcomes to show why fuel was necessary but not sufficient. Broad adoption windows and experimental analogs are not ancient output estimates, forest-loss models, adoption scores, market shares, hardness ranks, or universal thresholds.

Next is Iron Age insight 03: how carburization, heat treatment, welding, and workshop control made different irons behave differently.
