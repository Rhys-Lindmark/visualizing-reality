...
The Iron Age transformation now has its first of five insights live. Five regional comparisons separate earliest or limited evidence from wider adoption and make the production chain inspectable: prior metal traditions, ores and charcoal, furnace pathways, smithing and product quality, and institutions. The broad synthesis windows are not annual series, output estimates, adoption scores, market shares, hardness ranks, or universal thresholds.

Next is Iron Age insight 02: the charcoal and woodland constraint, with experimental anchors kept separate from ancient regional efficiencies.
