...
The Iron Age transformation now has three of five insights live. Five regional comparisons separate earliest or limited evidence from wider adoption and make the production chain inspectable. Eleven published modern smelting runs compare ore, charcoal, and reported bloom outcomes to show why fuel was necessary but not sufficient. Four paired bloom and forged-bar samples then separate hardness, chemistry, microstructure, and forgeability: the hardest mean bloom in the series was sulfur-rich, brittle, and difficult to forge. Broad adoption windows and experimental analogs are not ancient output estimates, forest-loss models, adoption scores, market shares, toughness tests, weapon-performance estimates, ancient averages, or universal thresholds.

Next is Iron Age insight 04: test when equipment abundance changed mobilization without converting metal finds into army headcounts or a military-power score.
