...
The Iron Age transformation now has four of five insights live. Five regional comparisons separate earliest or limited evidence from wider adoption and make the production chain inspectable. Eleven published modern smelting runs compare ore, charcoal, and reported bloom outcomes to show why fuel was necessary but not sufficient. Four paired bloom and forged-bar samples then separate hardness, chemistry, microstructure, and forgeability: the hardest mean bloom in the series was sulfur-rich, brittle, and difficult to forge. The fourth insight compares a pre-iron Egyptian field army, a qualitative pre-Roman European levy transition, and Taylor's like-for-like Carthaginian and Roman strategic-deployment models to show that cheaper equipment widened possibilities without creating recruitment, supply, or replacement institutions. Broad adoption windows, experiments, and mobilization cases are not ancient output estimates, forest-loss models, artifact-derived army totals, kilograms-per-soldier calculations, military-power scores, or universal thresholds.

Next is Iron Age insight 05: compare workshops, markets, specialist communities, standards, tribute, and state production without one centralization index.
