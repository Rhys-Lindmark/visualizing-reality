...
export default function BronzePalaceCircuits(){
  ...
  return <div className="palace-circuit-chart" style={{'--case-color':colors[active.case_id]} as React.CSSProperties}>
    <div className="palace-circuit-summary"><div><span>Cases compared</span><b>5</b><small>unlike institutional circuits</small></div><div><span>Shared capacity score</span><b>0</b><small>evidence types stay separate</small></div><div><span>Whole economies observed</span><b>0</b><small>every archive has an outside</small></div></div>
    ...
    <section className="palace-circuit-readout"><div><span>Inference limit</span><p>{active.limits}</p></div><div><span>Source keys</span><b>{active.source_keys}</b></div></section>
    ...
    <div className="cradle-downloads palace-circuit-downloads"><p><b>The palace is an aperture, not the economy.</b> Each row follows one unusually visible flow and states what the selected evidence cannot recover.</p><a href={dataUrl} download>Download circuits CSV ↓</a></div>
  </div>;
}
