...
export default function RomePage() {
  return (
    <HistoryPageShell
      ...
      methods={<><p>This is a working page. Two of five planned insights are live. Territorial geometry comes from the Seshat Global History Databank’s Cliopatria dataset and is simplified for web display over a Natural Earth physical basemap. Annual playback does not imply annual observations: each sourced boundary persists until the next dated geometry.</p><p>The military chart now separates unlike evidence rather than manufacturing uniformity. Seven Roman anchors are shown in four short, definition-consistent segments; blank years are evidence gaps, not zeroes. Rival dots are reported or reconstructed forces from particular campaigns. The only fifth-century Roman total shown is explicitly eastern, and its plotted date foregrounds the scholarly dispute over when the eastern Notitia Dignitatum describes. The equipment comparison is a relative index for the third and second centuries BCE because the public evidence supports a 25% worked-metal comparison—not precise kilograms for every army across a millennium.</p><EvidencePanel page="rome" /></>}
    >
