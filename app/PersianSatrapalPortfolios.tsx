...
export default function PersianSatrapalPortfolios(){
  ...
  return <div className="persia-satrapy-chart" style={{'--satrapy-color':colors[active.case_id]} as React.CSSProperties}>
    <div className="persia-satrapy-summary"><div><span>Bounded cases</span><b>5</b><small>five unlike administrative windows</small></div><div><span>Local portfolios</span><b>5</b><small>cities · dynasts · districts · estates · armies</small></div><div><span>Shared control scores</span><b>0</b><small>no invented autonomy scale</small></div></div>
    ...
    <section className="persia-satrapy-limit"><div><span>What this case does not prove</span><p>{active.limits}</p></div><div><span>Source keys</span><b>{active.source_keys}</b></div></section>
    <div className="cradle-downloads persia-satrapy-downloads"><p><b>A satrapy was an interface, not a copy.</b> Royal appointees connected the court to institutions that already had local authority, knowledge, and resources.</p><a href={dataUrl} download>Download five portfolios ↓</a></div>
  </div>;
}
