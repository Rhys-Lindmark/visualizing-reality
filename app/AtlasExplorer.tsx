...
const pages: AtlasPage[] = [
  ...
  { number:'07', title:'Qin and Han China', years:'475 BCE–220 CE', era:'Classical', region:'East Asia', system:'States', status:'draft', progress:'1 of 5 live', thesis:'Competition, registration, rewards, reporting, and logistics made conquest repeatable before unification.', href:'/qin-han' },
