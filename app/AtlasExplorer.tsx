...
const pages: AtlasPage[] = [
  ...
  { number:'03', title:'The cradles of civilization', years:'4000 BCE–1550 CE', era:'First cities', region:'Global', system:'Ecology', status:'draft', progress:'3 of 5 live', thesis:'Cities, states, monuments, notation, and bronze emerged by several routes—not as one civilizational package.', href:'/cradles' },
