...
const pages: AtlasPage[] = [
  ...
  { number:'02', title:'Uruk and the first states', years:'7000–2900 BCE', era:'First cities', region:'Mesopotamia', system:'States', status:'draft', progress:'2 of 5 live', thesis:'Water, grain, writing, and coerced labor made people and landscapes newly legible.', href:'/uruk' },
