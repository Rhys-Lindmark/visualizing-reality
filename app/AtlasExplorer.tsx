...
const pages: AtlasPage[] = [
  ...
  { number:'03', title:'The cradles of civilization', years:'4000–100 BCE', era:'First cities', region:'Global', system:'Ecology', status:'draft', progress:'1 of 5 live', thesis:'Urbanism and states emerged by several routes—not from one civilizational recipe.', href:'/cradles' },
