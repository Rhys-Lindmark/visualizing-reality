...
const pages: AtlasPage[] = [
  ...
  { number:'07', title:'Qin and Han China', years:'475 BCE–220 CE', era:'Classical', region:'East Asia', system:'States', status:'draft', progress:'3 of 5 live', thesis:'Competition built mobilizing systems; standards and a maintained logistics ecology made distance governable.', href:'/qin-han' },
