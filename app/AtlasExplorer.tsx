...
const pages: AtlasPage[] = [
  { number:'01', title:'Rome', years:'500 BCE–476 CE', era:'Iron Age', region:'Mediterranean', system:'States', status:'draft', progress:'2 of 5 live', thesis:'How an Italian coalition became a continental state—and why the Roman state survived its western court.', href:'/rome'},
