...
const pages: AtlasPage[] = [
  ...
  { number:'05', title:'The Iron Age transformation', years:'2000–400 BCE', era:'Iron Age', region:'Eurasia', system:'Technology', status:'draft', progress:'4 of 5 live', thesis:'Iron became transformative when fuel, furnaces, skills, exchange, and institutions made production repeatable—not when someone first found the metal.', href:'/iron-age' },
