...
const pages: AtlasPage[] = [
  ...
  { number:'06', title:'Persia and territorial empire', years:'550–330 BCE', era:'Iron Age', region:'Eurasia', system:'States', status:'draft', progress:'3 of 5 live', thesis:'Roads, satrapies, tribute, and negotiated rule made a new scale of empire possible.', href:'/persia' },
