...
export default function IronInstitutionCircuits(){
  ...
  return <div className="iron-institutions-chart" style={{'--institution-color':colors[active.case_id]} as React.CSSProperties}>
    <div className="iron-institutions-summary"><div><span>Bounded cases</span><b>5</b><small>five unlike evidence windows</small></div><div><span>Architectures</span><b>5</b><small>no universal sequence</small></div><div><span>Shared scale scores</span><b>0</b><small>institutions stay categorical</small></div></div>
    ...
    <section className="iron-institutions-limit"><div><span>What this case does not prove</span><p>{active.limits}</p></div><div><span>Source keys</span><b>{active.source_keys}</b></div></section>
    <div className="cradle-downloads iron-institutions-downloads"><p><b>The furnace was only one node.</b> Durable production also required access, skill, coordination, movement, and a social claim on the result.</p><a href={dataUrl} download>Download five cases ↓</a></div>
  </div>;
}
