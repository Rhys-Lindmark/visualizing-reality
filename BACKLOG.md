...
- Begin Page 02, **Uruk and the first states**, by auditing the proposed five-part argument and identifying one defensible, visual-first opening dataset. Do not publish Scott's grain-state thesis as settled fact; test it against archaeology and competing explanations.
