...
- Continue Page 02, **Uruk and the first states**, with insight 03: build a competing-evidence matrix for Scott's grain-state hypothesis using crop properties, wetland and pastoral subsistence, archaeobotany, institutional records, and serious counterarguments.
