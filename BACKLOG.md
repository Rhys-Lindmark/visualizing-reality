...
- Continue Page 02, **Uruk and the first states**, with insight 01: audit published settlement-area chronologies and the definitions separating sedentism, village growth, urban concentration, administration, and territorial state power. Do not publish a precise “birth of the state” date unless the evidence supports one.
